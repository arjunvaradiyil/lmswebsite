      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <li className="mb-2"><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">info@edumatrix.com</a></li>
        ...
        <div className="text-center mt-8 pt-8 border-t border-gray-700">
          <p className="text-gray-400">© 2024 EduMatrix. All rights reserved.</p>
        </div>
      </div>
    </section>
  )
